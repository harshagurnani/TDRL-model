function [NLL, NLL_L, NLL_R] = Get_NLL_ModelWithLapse(params, Data, includeContrast, varargin)
...
parfor iter = 1:iterN
   ...
   for trials = 1 : trialN
      ...
      Belief = normpdf(Bstimuli,contrast_withnoise,noiseSTD);
      ...
      elseif ActProb < lambdaL + lambdaR
          action(trials, iter) = 1;
      else
