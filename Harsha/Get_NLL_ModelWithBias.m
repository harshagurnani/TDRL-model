function [NLL, NLL_L, NLL_R] = Get_NLL_ModelWithBias(params,Data, includeContrast, varargin)
...
parfor iter = 1:iterN
   ...
   for trials = 1 : trialN
      ...
      QR(trials,iter) = Belief_L*QLR + Belief_R*QRR     + Qbias;    % Add fixed bias throughout
