 function AllThePlots_Bigger_7ParamsStriatum(Data, data_modelAll, actionAll, correctAll, xanswerMin, includeContrast, NLLData, varargin)
...
TrialThresh = NLLData.TrialThresh;
