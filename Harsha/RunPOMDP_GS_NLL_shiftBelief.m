function [data_model] = RunPOMDP_GS_NLL_shiftBelief(Data,params)
%% Run model where conditional probability of belief is shifted equally at all contrasts.
% Shift is given as deltaBF (4th parameter)
...
parfor iter = 1:iterN
   ...
   for trials = 1 : trialN
      ...
      Belief = normpdf(contrast,contrast_withnoise+deltaBF,noiseSTD);
